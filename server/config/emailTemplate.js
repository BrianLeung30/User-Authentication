export const WELCOME_TEMPLATE = (name) => `
  <div style="font-family: Arial, sans-serif; padding: 24px;">
    <h2 style="color: #4F46E5;">Welcome to Authentication App, ${name}!</h2>
    <p>We're excited to have you on board. You can now securely manage your account and access authentication features.</p>
    <br>
...
export const PASSWORD_RESET_TEMPLATE = (otp) => `
  ...
  <p>We received a request to reset your password for your Authentication App account.</p>
